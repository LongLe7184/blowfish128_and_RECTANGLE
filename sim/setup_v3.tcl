...
# Place each test relating file in seperate directory
set RESULTS_DIR "$SIM_DIR/$TEST_NAME"
...
vsim -wlf "$TEST_NAME.wlf" -t 1ps -novopt work.IBR128_tb_top +UVM_TESTNAME=$TEST_NAME +UVM_NO_DPI

# Configure logging and dumps
transcript file "$RESULTS_DIR/transcript.log"
log -r /*
